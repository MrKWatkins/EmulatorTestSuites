...
Standalone interrupt and HALT behaviour tests for [steppable](MrKWatkins.EmulatorTestSuites.Z80.Z80SteppableTestHarness.md) Z80 emulators.
...
The suite requires a steppable emulator because it advances one CPU step at a time and checks the recorded [cycle](MrKWatkins.EmulatorTestSuites.Z80.Cycle.md) type after each step.
