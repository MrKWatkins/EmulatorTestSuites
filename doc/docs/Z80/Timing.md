...
Each test runs the bundled program, reads back the measured values for the R register, loop counter and stack pointer, and compares them with the expected values embedded in the test data.
