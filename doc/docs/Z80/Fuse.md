...
The original tests can be found at [sourceforge.net/p/fuse-emulator](https://sourceforge.net/p/fuse-emulator/fuse/ci/master/tree/z80/tests/). Licensed under GPL-2.0 licence. Copyright © Philip Kendall.
